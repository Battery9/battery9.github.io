    ...
    <div className="text-white m-4">
      ...
      <div className="m-2 p-2 shadow-lg rounded-lg">
        <motion.p
          ...
          animate={{ opacity: 1 }}
        >
          <span>👋</span> Greetings! I'm Arpan Biswas, a prospective Web
          Developer with a diverse professional background. With prior
          experience as a back office executive, I bring a unique blend of
          skills to the table. Proficient in administrative roles and steadily
          advancing in web technologies, I'm committed to shaping remarkable
          online experiences. Eager to learn and poised to adapt, I'm actively
          pursuing opportunities to contribute my skills, whether in the realm
